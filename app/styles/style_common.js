...
export const stylesC = StyleSheet.create({
  ...
  popupContent:{height:370,width:310,backgroundColor:'white',alignItems:'stretch', borderRadius:20},
  // list
  ...
  menuItem:{margin:15,alignSelf:'stretch',flexDirection:'row',alignItems:'stretch',backgroundColor:Colors.white},
